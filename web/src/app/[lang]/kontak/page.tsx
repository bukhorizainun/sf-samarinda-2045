    ...
    <Halaman motif="amplang" adegan="pangan">
      ...
      <Section className="band border-t rule">
        <div className="grid gap-10 lg:grid-cols-[1fr_1fr] lg:gap-16">
          <div className="ubin self-start !p-8 hover:!translate-y-0 sm:!p-10">
            <h2 className="t-h3">
            ...
            <a
              ...
              className="btn btn-utama group mt-6 max-w-full"
            >
            ...
            <a
              ...
              className="btn btn-garis group mt-3 max-w-full"
            >
